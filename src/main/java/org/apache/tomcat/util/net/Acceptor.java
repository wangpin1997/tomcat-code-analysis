...
/**
 * @author wangpin
 * 套接字接受线程，用来接收用户请求，并把请求封装成事件任务放入到到Poller队列
 * 一个Connector只有一个Acceptor
 */
public class Acceptor<U> implements Runnable {
    ...
    public void run() {
        ...
        //一直循环接收请求，直到接收shutdown命令，才会关闭，也就是我们的服务退出了
        while (endpoint.isRunning()) {
            ...
            try {
                ...
                if (endpoint.isRunning() && !endpoint.isPaused()) {
                    ...
                    //设置套接字参数，并封装套接字成事件任务，然后放入Poller队列
